"""
ASAT – Auth Routes: Faculty Register / Login / Logout / Me
...
from app.schemas import Faculty
...
async def register_faculty(
    ...
    # Hash password — same bcrypt logic as original
...
async def login_faculty(
    ...
    # Verify password — same bcrypt.compare logic
