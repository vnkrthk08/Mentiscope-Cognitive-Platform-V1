...
from app.schemas import Student, Score
from app.models import StudentCreateRequest, StudentCreateResponse
...
async def create_student(
    ...
    if existing:
        # Return existing (allow retakes) — same behavior as original
...
async def get_student(
    ...
    # Get latest score — same query as original
    score_result = await db.execute(
        select(Score)
    ...
    if score:
        ...
        # module_results is already a dict from JSONB — no JSON.parse needed
