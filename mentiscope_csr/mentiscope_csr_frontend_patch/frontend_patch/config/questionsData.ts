...
export const QUESTIONS_DATA: { [moduleId: string]: Question[] } = {
  ...
  // "gsm" previously had a client-side mock question bank here. It has been
  // removed: the module is now backed by the real CSR FastAPI microservice
  // (see services/modules/gsm.ts), which returns live questions from
  // /api/modules/csr/start and /answer — mirroring how "processing-speed"
  // has no static entry in this file either.
  gf: [
    {
      id: "gf-1",
