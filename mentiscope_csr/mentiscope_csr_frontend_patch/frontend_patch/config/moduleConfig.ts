...
export const MODULE_CONFIGS: ModuleConfig[] = [
  ...
  {
    id: "gsm",
    name: "Working Memory (GSM) — Classroom Scenario Recall",
    description: "Measures auditory recall, visual grid memory, interference resistance, and sequential updating via the Classroom Scenario Recall (CSR) task battery.",
    icon: "Activity",
