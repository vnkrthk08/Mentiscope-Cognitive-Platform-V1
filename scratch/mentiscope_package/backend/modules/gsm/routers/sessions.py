...
from modules.gsm.schemas import Session as SessionModel, Score, Event
...
async def update_session(
    ...
    # Mark session completed â€” same SQL as original
    ...
    # Upsert scores â€” same logic as original
    if payload.scores:
...
async def save_module_result(session_id: int):
    ...
    """
    # Original was also lightweight â€” actual score save happens at PATCH
...
async def save_events(
    ...
    # Bulk insert â€” same fields as original
    event_objects = [
        Event(
            student_id=payload.studentId,
