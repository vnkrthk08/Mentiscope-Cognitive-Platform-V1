...
$destDir = "c:\Users\venka\Desktop\trail iitm\temp_build_zip"
$zipPath = "c:\Users\venka\Desktop\mentiscope-processing-speed-live-integration.zip"
...
Get-ChildItem -Path $src -Recurse | Where-Object { 
    ...
    $_.FullName -notmatch "temp_build_zip" 
} | ForEach-Object {
